...
if __name__ == "__main__":
    ...
    min_number = 20
    data = []
    if "instrument5c.json" in input_path or "pantry5c.json" in input_path or "music5c.json" in input_path or "office5c.json" in input_path:
    ...
    #print( len(test_item_idx)/num_items, len(train_item_idx)/num_items, len(val_item_idx)/num_items)
    #print(num_items, len(item_occurrences))
